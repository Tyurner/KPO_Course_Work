...
public class ApplicantSubjectsTests
{
    ...
    public void ApplicantSubjectsTest_Add()
    {
        ...
        driver.Navigate().GoToUrl("https://localhost:44327/Home/ApplicantSubjects/1");

        var subjectSelect = driver.FindElement(By.Id("subjectId"));
        var pointsField = driver.FindElement(By.Name("points"));
    ...
    [Test]
    public void ApplicantSubjectsTests_Delete()
    {
        driver.Navigate().GoToUrl("https://localhost:44327/Home/Enter");
